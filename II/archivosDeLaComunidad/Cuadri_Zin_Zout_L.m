...
fprintf('\n\n\n\n');
fprintf('                  CALCULO DE CUADRIPOLOS TIPO "L" , ADAPTADORES DE IMPEDANCIA\n');
fprintf('\n\n');
...
fprintf('                               |           \n');
fprintf('O----------------------x-----------------O\n\n');
ALFA=acosh(sqrt(ZIN/ZOUT));
fprintf(' \n');
fprintf('Atenuaci?n ALFA = acosh(sqrt(ZIM1/ZIM2)) = %8.4f [Neppers]\n\n',ALFA);
Z1 = (sqrt(ZIN*ZOUT)*sinh(ALFA));
...
fprintf('                        |           \n');
fprintf('O----------------x------------------------O\n\n');
ALFA=acosh(sqrt(ZOUT/ZIN));
fprintf(' \n');
fprintf('Atenuaci?n ALFA = acosh(sqrt(ZIN/ZOUT)) = %8.4f [Neppers]\n\n',ALFA);
Z1=0;
Z2 = (sqrt(ZIN*ZOUT)/sinh(ALFA));
Z3 = (sqrt(ZIN*ZOUT)*sinh(ALFA));
fprintf('Z1 = %8.4f [Ohms]\n',Z1);
fprintf('Z2 = (sqrt(ZIN*ZOUT))/sinh(ALFA) = %8.4f [Ohms]\n',Z2);
fprintf('Z3 = (sqrt(ZIN*ZOUT))*sinh(ALFA) = %8.4f [Ohms]\n',Z3);  
end    
